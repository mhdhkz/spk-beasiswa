...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	if (empty($nama)) {
		echo alert("Nama mahasiswa tidak boleh kosong!", "?page=kriteria");
		exit;
	}
	if ($sifat !== 'max' && $sifat !== 'min') {
		echo alert("Silahkan pilih sifat kriteria terlebih dahulu!", "?page=kriteria");
		exit;
	}
