...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	if ($q_beasiswa->num_rows == 0) {
        echo alert("Beasiswa yang dipilih tidak ada!", "?page=penilaian");
        exit;
    }
	if (empty($keterangan)) {
		echo alert("Keterangan tidak boleh kosong!", "?page=penilaian");
		exit;
	}
	if (empty($bobot)) {
		echo alert("Bobot tidak boleh kosong!", "?page=penilaian");
		exit;
	}
