...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	if ($q_beasiswa->num_rows == 0) {
        echo alert("Beasiswa yang dipilih tidak ada!", "?page=kriteria");
        exit;
    }
	if ($update) {
	...
	if ($validasi) {
		$q = $connection->query("SELECT kd_model FROM model WHERE kd_beasiswa='$_POST[kd_beasiswa]' AND kd_kriteria='$_POST[kd_kriteria]'");
		if ($q->num_rows) {
...
<div class="row">
	...
	<div class="col-md-8">
	    <div class="panel panel-info">
	        <div class="panel-heading"><h3 class="text-center">DAFTAR MODEL</h3></div>
	        <div class="panel-body">
